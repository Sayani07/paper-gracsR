---
title: "4 designs and 5 iterations and categorty changes across 2 granularities (g3 categories const) "
author: "Sayani Gupta"
output:
  bookdown::pdf_book:
...
```{r}
design = c("design-1", "design-2", "design-3", "design4")
g1 = c("no", "no", "yes", "yes")
g2 = c("no", "yes", "no", "yes")
g3 = c("no", "no", "no", "no")
