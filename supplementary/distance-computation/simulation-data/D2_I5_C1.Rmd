---
title: "2 designs and 5 iterations and categorty changes across 1 granularity (g3 and g1 categories const) "
author: "Sayani Gupta"
output:
  bookdown::pdf_book:
...
g2 <- n %%3
g3 <- n %%5
mu1= c(0, 0) # mean of cat of g1
mu2 = c(7, 5, 1)# mean of cat of g2
mu3 = c(0, 0, 0, 0, 0) # mean of cat of g3
```
...
design2 = distributional::dist_normal(g1_dnull + g2_dvary + g3_dnull)
#design3 = distributional::dist_normal(g1_dnull + g2_dvary + g3_dnull)
#design4 = distributional::dist_normal(g1_dvary + g2_dvary + g3_dnull)
...
groups = dist_mat%>% clust_gran(kopt = 2 )
...
# _Cluster designs: distance using js distance between categories_
