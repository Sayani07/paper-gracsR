---
title: "Selecting similar behaving group of customers to check nqt clustering methodology"
...
wkndwday <- read_rds("../../../data/dist_gran_wkndwday_356cust_nqt.rds") %>% broom::tidy() 

moy <- read_rds("../../../data/dist_gran_moy_356cust_nqt.rds") %>% broom::tidy()

hod <- read_rds("../../../data/dist_gran_hod_356cust_nqt.rds") %>% broom::tidy()
...
cols <- toRGB(RColorBrewer::brewer.pal(5, "Dark2"))
subplot(mds_total, mds_hod, mds_moy ,mds_wkndwday, titleX = TRUE) %>%
  layout(showlegend = FALSE) %>%
  highlight(on = "plotly_selected", dynamic = TRUE, selectize = TRUE, selected = attrs_selected(0.5), opacityDim = 0.2, off = "plotly_deselect", persistent = TRUE,defaultValues = data_pick_cust$value, color = cols) 
```
