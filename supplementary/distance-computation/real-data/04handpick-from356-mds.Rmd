...
subplot(mds_total, quantile_plot, widths = c(.6, .4), titleX = TRUE) %>% layout(showlegend = FALSE) %>% highlight(on = "plotly_selected", dynamic = TRUE, selectize = TRUE, selected = attrs_selected(0.5), opacityDim = .2, off = "plotly_deselect")
