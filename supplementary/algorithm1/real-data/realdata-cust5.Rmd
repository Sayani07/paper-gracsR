---
title: "Clustering real data with five customers and choosing optimal number of clusters"
output:
  bookdown::pdf_book:
...
sm <- gravitas::smart_meter10 %>%
  filter(customer_id %in% c("10006704", "10017936", "10006414", "10018250", "10018064"))
```
