---
title: "Clustering real data with ten customers and choosing optimal number of clusters"
output:
  bookdown::pdf_book:
...
```{r hod-box, fig.cap="The raw plots for 5 households shown for Sept 2013-Oct 2013. The data is zoomed in to emphasize weekly, hourly or any behavior/patterns that they might have.", eval = FALSE}
sm %>% 
