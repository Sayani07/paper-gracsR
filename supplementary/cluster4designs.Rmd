...
```{r data-make}
data_null <- map(seq_len(sample_seed), function(seed){
...
data_varf <- map(seq_len(sample_seed), function(seed){
  set.seed(sample_seed[seed])
...
data_varx <- map(seq_len(sample_seed), function(seed){
  set.seed(sample_seed[seed])
...
data_varall <- map(seq_len(sample_seed), function(seed){
  set.seed(sample_seed[seed])
