...
wkndwday_group <- wkndwday_data%>% 
  ...
  geom_boxplot(aes(fill = as.factor(group)),alpha = 0.5)+
...
```{r combined-groups-js, fig.cap = "The distribution of electricity demand for the clusters across hour-of-day, month-of-year and wknd-wday. Group 2 and 5 have a stronger hour-of-day pattern, while group 1, 3, 5 have a month-of-year pattern. For wknd-wday differences across different groups are not distinct suggesting that it might not be that important a variable to distinguish different clusters."}
(hod_group + moy_group + wkndwday_group) +  plot_layout(guides = "collect")
```
