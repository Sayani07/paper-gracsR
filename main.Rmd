...
```{r gran2and1-clubbed, fig.cap=" Plots (b) and (c) correspond to Scenarios (b) and (c) respectively. In (b) $g2$, $g3$ changes across atleast one design but $g1$ remains constant. Only $g3$ changes across different designs in (c)."}
