...
Figure \ref{fig:summary-plot-wpd} shows the $wpd$ values $hod$, $moy$, and $wnwd$ of the $24$ customers, colored by $3$ (a) and $5$ (b) cluster solution as suggested by Figure \ref{fig:opt-cluster-tsne-jsd} through a parallel coordinate plot. The variables (wpd's for different granularities) are 
