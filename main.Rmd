...
```{r opt-cluster-tsne-jsd, fig.cap = "(a) shows t-SNE summary of the 24 customers chosen through prototype selection, (b) shows a plot of sindex for different cluster size $k$"}
