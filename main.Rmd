...
```{r data-heatmap-wkndwday-group-new}
data_group <- data_pick %>% 
  mutate(customer_id = as.character(customer_id)) %>% 
  left_join(cluster_result, by = c("customer_id" = "id"))
...
parcoord <- GGally::ggparcoord(data_pcp ,
  ...
  theme(legend.position = "bottom") +
  xlab("") +
  ylab("wpd")  +   scale_color_manual(legend_title, values = c("#E69F00", "#009E73","#0072B2", "#D55E00"))
pairsplot
```
