...
```{r plot-3gran-new, out.width="100%", fig.cap="The linear (left) and cyclic (right) representation of the simulated variable is shown. Each row represents a design in Scenario (a). In this scenario, all of $g1$, $g2$ and $g3$ changes across at least one design. Also, it is not possible to comprehend these distributional differences in patterns just by looking at or considering the linear representation."}
