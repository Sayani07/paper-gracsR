...
- Obtain $wpd$ for all cyclic granularities considered for these customers. It was found that $hod$ (hour-of-day), $moy$ (month-of-year) and $wnwd$ (weekend/weekday) are turning out to be significant for most customers. We use these three granularities while clustering.
