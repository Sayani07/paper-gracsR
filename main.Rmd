...
### Individual granularities
  ...
  _(a) All signifiant granularities_
...
_(b) Few significant granularities_
...
\noindent Here only one granularity is responsible for distinguishing the designs. Designs change significantly only for the granularity $g2$. Figure \ref{fig:plot-1gran} shows this.


```{r tab-distribution, fig.pos="htb"}
