...
For $5$ cluster solution, this groups gets split into Q3-Q5 characterizing different relative significance of $moy$ and $wnwd$. For example, Q-4 and Q-5 have almost no pattern across $moy$, but Q-3 has a $moy$ pattern and thus it is reasonable to split them. The patterns could be different, but they are significant. Q-4 and Q-5 are separated because of their significance across $hod$.
