...
Figure \ref{fig:summary-plot-wpd} shows the $wpd$ values of the $24$ customers over $hod$, $moy$, and $wnwd$ , colored by $3$ (a) and $5$ (b) clusters from WPD clustering using a parallel coordinate plot. The variables (wpd's for different granularities) are 
