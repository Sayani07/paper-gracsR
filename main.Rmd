...
table <- tibble(design, g1, g2, g3) %>% kable(caption = "5 different designs resulting from considering different distributions across categories.")
table
