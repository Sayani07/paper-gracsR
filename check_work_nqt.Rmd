...
mds_all <- read_rds(here("data/mds_all_nqt.rds"))  %>% 
...
aes(x = mds1.total, y = mds2.total)) +
  ...
  geom_point(data = highlight_df, 
             aes(x = mds1.total, y = mds2.total, color = as.factor(design)))

wpd_plot <- ggplot(mds_all,
aes(x = mds1.wpd, y = mds2.wpd)) +
  geom_point(alpha = 0.3) +
  geom_point(data = highlight_df, 
             aes(x = mds1.wpd, y = mds2.wpd, color = as.factor(design)))
  
hod_plot <- ggplot(mds_all,
aes(x = mds1.hod, y = mds2.hod)) +
  geom_point(alpha = 0.3) +
  geom_point(data = highlight_df, 
             aes(x = mds1.hod, y = mds2.hod, color = as.factor(design)))
...
aes(x = mds1.moy, y = mds2.moy)) +
  geom_point(alpha = 0.3) +
  geom_point(data = highlight_df, 
             aes(x = mds1.moy, y = mds2.moy, color = as.factor(design)))
